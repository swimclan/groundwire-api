...
/* EXPORTS */
module.exports.buildOrderOptions = function(creds, instrumentUrl, quantity, price, minTick, stopOptions) {
	let credentials = checkCreds(creds);
	var self = this;
	var options = {
		type: "market",
		time_in_force: "gfd",
		bid_price: minTick ? utils.moneyify(utils.roundDown(price, parseFloat(minTick))) : utils.moneyify(price),
		quantity: quantity,
...
module.exports.findQueuedSellOrderByInstrument = function(creds, instrumentId, trigger) {
	let credentials = checkCreds(creds);
	return new Promise(function(resolve, reject) {
		var rh = Robinhood(credentials, function() {
			rh.orders(function(err, response, body) {
...
module.exports.cancelQueuedStopSell = function(creds, instrumentId) {
	...
	var self = this;
	return new Promise(function(resolve, reject) {
		self.findQueuedSellOrderByInstrument(credentials, instrumentId, 'stop')
		.then(function(order) {
...
module.exports.cancelQueuedMarketSell = function(creds, instrumentId) {
	let credentials = checkCreds(creds);
	var self = this;
	return new Promise(function(resolve, reject) {
		self.findQueuedSellOrderByInstrument(credentials, instrumentId, 'immediate')
		.then(function(order) {
			var targetOrder = order;
			var rh = Robinhood(credentials, function() {
				rh.cancel_order(targetOrder, function(err, response, body) {
